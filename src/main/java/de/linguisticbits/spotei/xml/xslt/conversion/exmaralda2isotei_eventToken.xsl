...
<!-- 
    NAME: exmaralda2isotei_eventToken.xsl
    INPUT: an EXMARaLDA Basic Transcription (exb) 
        - this is an XML file as written by the EXMARaLDA Partitur-Editor
        - in tiers of type 'T(ranscription)', every event shoud correspond to exactly one token
    PARAMETERS:
    ...
    OUTPUT: an ISO/conformant transcription file, tokenisation of <u> into <w>, no segmentation into <seg> 
    =================================================================
    HISTORY:
    - change 03-03-2016: additional namespaces no longer necessary 
     ...
     - change 09-01-2026: transferred to spotei, documentation added 
-->        
